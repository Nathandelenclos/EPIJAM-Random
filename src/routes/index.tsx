...
function Home() {
  const stats = [
    { name: 'Des 3D', path: '/dice-3d', value: 'roll interactif', tag: 'New' },
    { name: 'Crate Rush', path: '/games', value: 'x32 max', tag: 'Games' },
    { name: 'Tables Live', path: '/tables', value: '6 salons', tag: 'Live' },
    { name: 'Missions', path: '/missions', value: '5 challenges', tag: 'Daily' },
  ...
  return (
    <section className="space-y-5">
      ...
      >
        ...
        {/* Decorative vertical lines on right */}
        ...
        <p className="val-kicker mb-4">Neon Stakes</p>
        ...
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-[#a8b0b8]">
          Montez votre bankroll entre une partie classée et un clutch en overtime. Tables live, mini-jeux tactiques
          et missions quotidiennes avec bonus de rang.
        </p>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {stats.map((item) => (
          ...
          >
            ...
            <p className="display-title mt-2 text-3xl text-white">{item.name}</p>
